...
export default function SubmissionResultStep() {
  const Legend = ({ children }) => (<legend className='text-red-600 text-center font-semibold mb-1.5 bg-[#ced4db] z-[1] absolute py-1 -translate-y-1/2 left-7 right-7 whitespace-nowrap rounded-md border border-solid border-black text-xs'>{children}</legend>)
      ...
      <div className="grid grid-cols-4 gap-x-12 text-sm">
        <div className='space-y-12'>
          ...
          <div className='relative'>
            ...
            <Card className='!border-black rounded-sm'>
              <CardContent className='p-4 space-y-3 pb-0'>
                <FormField control={form.control}
                  name='job-hours'
                  render={({ field }) => (
                    <FormItem>
                ...
                <FormField control={form.control}
                  ...
                  render={({ field }) => (
                    <FormItem className='flex justify-center'>
                      <FormControl>
                        <Checkbox id='non-school' />
                      </FormControl>
                      <FormLabel className='font-normal ml-1'>non-school</FormLabel>
                    </FormItem>
                  )} />
              </CardContent>
            </Card>
